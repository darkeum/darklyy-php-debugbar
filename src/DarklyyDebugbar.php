...
use Darkeum\Debugbar\Storage\SocketStorage;
use DebugBar\DataCollector\ConfigCollector;
use Darkeum\Debugbar\DataCollector\MemoryCollector;
use DebugBar\DataCollector\MessagesCollector;
use DebugBar\DataCollector\TimeDataCollector;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;
use Darkeum\Debugbar\Storage\FilesystemStorage;
use DebugBar\DataCollector\ExceptionsCollector;
use DebugBar\DataCollector\RequestDataCollector;
use Darkeum\Debugbar\DataCollector\AuthCollector;
use Darkeum\Debugbar\DataCollector\GateCollector;
use Darkeum\Debugbar\DataCollector\LogsCollector;
use Darkeum\Debugbar\DataCollector\ViewCollector;
use Darkeum\Debugbar\DataCollector\CacheCollector;
use Darkeum\Debugbar\DataCollector\EventCollector;
use Darkeum\Debugbar\DataCollector\FilesCollector;
use Darkeum\Debugbar\DataCollector\QueryCollector;
use Darkeum\Debugbar\DataFormatter\QueryFormatter;
use DebugBar\Bridge\SwiftMailer\SwiftLogCollector;
use DebugBar\DataCollector\DataCollectorInterface;
use Darkeum\Debugbar\DataCollector\ModelsCollector;
use DebugBar\Bridge\SwiftMailer\SwiftMailCollector;
use Darkeum\Debugbar\DataCollector\LaravelCollector;
use Darkeum\Debugbar\DataCollector\PhpInfoCollector;
use Darkeum\Debugbar\DataCollector\RequestCollector;
use Darkeum\Debugbar\DataCollector\SessionCollector;
use Darkeum\Debugbar\DataCollector\MultiAuthCollector;
use Darkeum\Debugbar\Support\Clockwork\ClockworkCollector;
 ...
 */
class DarklyyDebugbar extends DebugBar
{
    /**
     * The Laravel application instance.
     *
     * @var \Boot\App\Application
     */
    protected $app;
    ...
    public function boot()
    {
        ...
        /** @var \Darkeum\Debugbar\DarklyyDebugbar $debugbar */
        $debugbar = $this;
        ...
        if (!$this->isLumen() && $this->shouldCollect('route')) {
            try {
                $this->addCollector($this->app->make('Darkeum\Debugbar\DataCollector\RouteCollector'));
            } catch (\Exception $e) {
                $this->addThrowable(
                    new Exception(
                ...
                if ($this->hasCollector('messages')) {
                    ...
                    $this->app['log']->listen(
                        function ($level, $message = null, $context = null) use ($logger) {
                            ...
                            if ($level instanceof \Boot\System\Log\Events\MessageLogged) {
        ...
        if ($this->shouldCollect('models', true)) {
            try {
                $modelsCollector = $this->app->make('Darkeum\Debugbar\DataCollector\ModelsCollector');
        ...
        if ($this->shouldCollect('livewire', true) && $this->app->bound('livewire')) {
            try {
                $livewireCollector = $this->app->make('Darkeum\Debugbar\DataCollector\LivewireCollector');
        ...
        if ($this->shouldCollect('gate', false)) {
            try {
                $gateCollector = $this->app->make('Darkeum\Debugbar\DataCollector\GateCollector');
    ...
    public function injectDebugbar(Response $response)
    {
        ...
        $original = null;
        if ($response instanceof \Boot\System\Http\Response && $response->getOriginalContent()) {
